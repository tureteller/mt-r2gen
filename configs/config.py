...
# ========================= Model Settings ============================
parser.add_argument('--vision_model', default='/data/tmp_ymy/huggingface/models--microsoft--swin-base-patch4-window7-224/snapshots/20d6c26ef6455d36c0a78671d787c5da57513d4b', type=str, help="vision model to use")
parser.add_argument('--llama_model', default='/data/tmp_ymy/huggingface', type=str, help="LLM model to use")
